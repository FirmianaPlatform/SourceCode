...
NFS89_dir = os.path.join( os.path.dirname( __file__ ), '..','..','..','database','files')
...
def calcAreas(file_data, dRT, dMZ, ins_pep):
    ...
    dir_MS1 = '%s/ms_peak_tmp/%s/MS1.txt' % (NFS89_dir, filename)  # Dir of .txt files of peaks
...
def __main__() :
    ...
    calcAreas(file_data, dRT, dMZ, ins_pep)
