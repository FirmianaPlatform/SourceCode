											...
											menu: [{
												...
												listeners: {
													checkchange: function(item, checked) {
									            		if(checked){
								            				downloadTypeList.push(item.value)
									            		}else{
									            			downloadTypeList.remove(item.value)
									            		}
									            	}
												}
											}, {
												...
												handler: function() {
													...
													s += '|'
													for(var i = 0; i < downloadTypeList.length; i++){
														s += downloadTypeList[i]
														if(i != downloadTypeList.length - 1){
															s += ';'
														}
													}
													console.log(s)
													
													window.open('/gardener/data/downloadExperimentViewer/' + encodeURIComponent(s));
												}
											}]
										}, 
										// {
