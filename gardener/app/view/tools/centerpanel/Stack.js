Ext.define('gar.view.tools.centerpanel.Stack',{
    extend: 'Ext.panel.Panel',
    alias: 'widget.Density',
    width: 600,
    split: true,
    floatable: false,
    closable: true,
    ...
    initComponent: function() {
				...
				success : function(response) {
                    ...
                    if (tryNormalize == 2) 
                    {
                       ...
                       //                      	add a new param into grid store named "Nomalize"
                                                ...
                                                normalizationLevel = 'Stack_' + Ext.getCmp('plotlevel' + timestamp).value
        ...
        var mainImg = Ext.create('Ext.Img', {
            xtype: 'image',
            id: 'toolsStackMainImg' + timestamp
        })
    	...
    	this.items = [{
	        ...
	        items: [{
	        	...
	        	handler: function() {
	        		...
	        		//Status bar notice
//	        		Ext.getCmp('toolsStatusBarPanel').remove(Ext.getCmp('toolsStatusBar'))
