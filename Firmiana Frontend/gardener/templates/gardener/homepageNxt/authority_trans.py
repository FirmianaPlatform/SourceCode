...
new_path = []
new_path.append(settings.GALAXY_LIB_PATH)
new_path.extend( sys.path[1:] )
sys.path = new_path
for egg in os.listdir(settings.GALAXY_EGG_PATH): 
    new_path.append(os.path.join(settings.GALAXY_EGG_PATH, egg) )

import pkg_resources
#import galaxy.web
#import galaxy.web.security
...
class SecurityHelper:
    def __init__( self):
        self.id_secret = settings.GALAXY_ID_SECRET
...
if __name__ == "__main__":
    sessioncookie =  sys.argv[1]
    print(SecurityHelper().decode_guid(sessioncookie))

# print(SecurityHelper().encode_guid("f240073534da1dbe127e160e0e6846f6"))
# print(SecurityHelper().decode_guid("3ea0fcfc6f6dc4032cd0503e8e491bf75ed25567d402f530961569e7d2f2c663982d6ce15377c54e"))
