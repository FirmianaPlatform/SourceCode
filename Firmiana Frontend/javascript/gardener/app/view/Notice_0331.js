																...
																var tree = Ext.create('gar.view.CompareTree', {
																			...
																			onGroupDone : function(parentNode, childNode) {
																				...
																				if (data == 'Group') {
																					...
																					for (i = begin_no; i < newcolumndata.length; i++) {
																						console.log(newcolumndata[i])
																						idx = ''
																						for (j = 0; j < out.length; j++) {
																							if (out[j].split('|')[0] == newcolumndata[i].text) {
																								idx = out[j].split('|')[1]
																							}
																						}
																						var z = new Object();
																						z["dataIndex"] = idx + '|' + 'Average'
																						z["text"] = "Avearge"
																						z["sortable"] = true
																						z["filter"] = {
																							'type' : 'float',
																						...
																						newcolumndata[i].columns.push(z)
																						var z = new Object();
																						z["dataIndex"] = idx + '|' + 'Mean'
																						z["text"] = "MEAN"
																						z["sortable"] = true
																						z["filter"] = {
																							'type' : 'float',
																					...
																					for (i = begin_no; i < newcolumndata.length; i++) {
																						for (j = 0; j < newcolumndata[i].columns.length; j++) {
																							idx = ''
																							for (k = 0; k < out.length; k++) {
																								if (out[k].split('|')[0] == newcolumndata[i].text + '_' + newcolumndata[i].columns[j].text) {
																									idx = out[k].split('|')[1]
																								}
																							}
																							var z = new Object();
																							...
																							newcolumndata[i].columns[j].columns.push(z)
																							var z = new Object();
																							z["dataIndex"] = idx + '|' + 'Mean'
																							z["text"] = "MEAN"
																							z["sortable"] = true
