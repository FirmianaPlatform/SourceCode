							...
							items : [
								...
								/* {
									...
									},*/
									{
										...
										iconCls: 'btdatarepository',
										menu: {
											items:[{
												text : 'Repository Center',
												handler: function(){
													window.open('/repository/')
													Ext.state.CookieProviderView.setCookie('username',Ext.util.Cookies.get('username'))
												}
