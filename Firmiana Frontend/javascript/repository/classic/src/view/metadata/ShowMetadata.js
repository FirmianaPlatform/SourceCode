Ext.define('dataViewer.view.metadata.ShowMetadata', {
    ...
    initComponent: function() {
        ...
        var pxdNo = this.project_pxdNo
        var data = {}

        me = this
        // Ext.Ajax.request({
        //     url: '/repos/showMetadataByPxdNo/',
        //     method: 'GET',
        //     params: {
        //         pxdNo: pxdNo
        //     },
        ...
        //         Ext.Msg.alert('Failed', 'Failed to get metadata of this project.');
        //     }
        // })
        ...
        this.items = [{
            ...
            items:[{
                xtype: 'form',
                id: 'meta_form',
                url:'/repos/updateMetadataByPxdNo/',
                method: 'GET',
                layout: 'accordion',
                defaults: {
                    border: false,
    ...
    afterRender: function() {
        Ext.getCmp('meta_form').getForm().load({
            url: '/repos/showMetadataByPxdNo/',
            params: {
                pxdNo: this.project_pxdNo
            },
            // reader: {
            //     type: 'json',
            //     rootProperty: 'data'
