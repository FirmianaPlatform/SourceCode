Ext.onReady(function() {
					...
					select : function(combo, record, index) {
						Ext.Ajax.request({
									...
									success : function(response) {
										...
										combo.up().items.items[1]
												.setValue(responseJson.experimenter);
										combo.up().items.items[2]
												.setValue(responseJson.date);
										combo.up().items.items[3]
												.setValue(responseJson.txid);
										combo.up().items.items[4]
												.setValue(responseJson.cell_tissue);
									}
								});
					}
				}
	...
	formPanel = Ext.create('Ext.form.Panel', {
				id : 'formPanel',
				renderTo : 'form',
				items : [generalPanel, separationPanel, digestPanel,
						instrumentPanel, commentPanel, buttonPanel]
				,
			});
