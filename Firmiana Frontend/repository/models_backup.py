...
class ProjectDetail(models.Model):
    ...
    experimentType = models.ForeignKey(Miape_ExpType, unique=False)
    species = models.ForeignKey(Miape_Species, unique=False)
    tissue = models.ForeignKey(Miape_Tissue, unique=False)
    modification = models.ForeignKey(Miape_Modification, unique=False)
    instrument = models.ForeignKey(Miape_Instrument, unique=False)
    cellType = models.ForeignKey(Miape_CellType, unique=False)
    disease = models.ForeignKey(Miape_Disease, unique=False)
    quantMethods = models.ForeignKey(Miape_QuantMethod, unique=False)
