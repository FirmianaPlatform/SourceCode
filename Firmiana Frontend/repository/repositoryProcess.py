...
def addMetadataForAProject(parametersDict):
    ...
    try:
        ...
        experimentType = parametersDict['experimentType']
        species = parametersDict['species']
        tissue = parametersDict['tissue']
        modification = parametersDict['modification']
        instrument = parametersDict['instrument']
        cellType = parametersDict['cellType']
        disease = parametersDict['disease']
        quantMethods = parametersDict['quantMethods']
    ...
    if guestFlag:
        ...
        if allProjects:
            for project in allProjects:
                ...
                tmpDict["species"] = projectDetail.species
...
def showMetadataByPxdNo(pxdNo):
    ...
    try:
        ...
        parametersDict['ExperimentType'] = aProjectMetadata.experimentType
        parametersDict['Species'] = aProjectMetadata.species
        parametersDict['Tissue'] = aProjectMetadata.tissue
        parametersDict['Modification'] = aProjectMetadata.modification
        parametersDict['Instrument'] = aProjectMetadata.instrument
        parametersDict['CellType'] = aProjectMetadata.cellType
        parametersDict['Disease'] = aProjectMetadata.disease
        parametersDict['QuantMethods'] = aProjectMetadata.quantMethods
...
def updateMetadataForAProject(parametersDict):
    ...
    if not isPublicatedProject(pxdNo):
        ...
        experimentType = parametersDict['experimentType']
        species = name=parametersDict['species']
        tissue = parametersDict['tissue']
        modification = parametersDict['modification']
        instrument = parametersDict['instrument']
        cellType = parametersDict['cellType']
